...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2016 at 06:16 PM
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='This table stores information of parts of injector';
...
CREATE TABLE `compressor_problem` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `compressor_repair` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `compressor_status` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `compressor_type_backup` (
  `id` int(11) NOT NULL,
  `compressor_type_id` varchar(5) COLLATE utf8_unicode_ci DEFAULT NULL,
  `name_eng` text COLLATE utf8_unicode_ci,
  `name_th` text COLLATE utf8_unicode_ci
...
CREATE TABLE `customer_category` (
  `id` int(11) NOT NULL COMMENT 'Auto generated incremented Primary key of the table.',
  `customer_category_id` varchar(5) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Unique ID assigned to each category.',
  `name_eng` text COLLATE utf8_unicode_ci,
  `name_th` text COLLATE utf8_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Customer Categories.';
...
CREATE TABLE `dealer` (
  `ID` int(11) NOT NULL COMMENT 'Auto generated key of the table.',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Table consisting the list of all the dealers.';
...
(843, '00100001', 'TOYO ONE', 'โตโยวัน', '001', 'Thailand', 'ไทยแลนด์', 'BKK', '10220', '02-222-3333', '089-123-4444', '02-888-0000');
...
CREATE TABLE `dealer_relationship` (
  `ID` int(11) NOT NULL COMMENT 'Auto generated key of the table.',
  `dealer_id` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Alphanumeric key assigned to each dealer.',
...
(187, '00100001', 'SD0070', '001', 'denso', '2016-09-20 15:34:24');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Table to store different part types.';
...
(8, 'P01', '001', 'winney', 'XXXXX', 'YYYY', '000111', '000222', '2016-09-08', '2016-09-30');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='An SD may allow for certain part types.';
...
(17, 'SD0070', '0004', 'denso', '2016-09-20 15:31:43'),
(18, 'SD0070', '0003', 'denso', '2016-09-20 15:31:43'),
(19, 'SD0070', '0002', 'denso', '2016-09-20 15:31:43'),
(20, 'SD0001', '0004', 'denso', '2016-09-21 17:15:36'),
(21, 'SD0001', '0003', 'denso', '2016-09-21 17:15:36'),
(22, 'SD0001', '0002', 'denso', '2016-09-21 17:15:36'),
(23, 'SD0001', '0001', 'denso', '2016-09-21 17:15:36'),
(24, 'SD0070', '0001', 'denso', '2016-09-21 17:29:11');
...
(16, 'SD0016', 'sahakit!!!!', 'ร้านสหกิจดีเซล', 'N-E', 'W', '18-20   ถ.แจ้งสนิท  หน้าแขวงการทาง อ.เมือง จ.อุบลราชธานี 34000', '045-281-858', '045-281-858,045-241149มือถือ 089-8461-812', '045-281879', 'คุณเสกสรร มงคลเสริมศิริ', 'win_zuza@hotmail.com'),
...
(66, 'SD0070', 'winney service', 'วินนี่ การช่าง', 'BKK', 'W', 'Ramindra Road Bangkok Thailand  10220', '0-2222-7777', '02-555-7765', '02-222-3333 to 5', 'winney', 'win_zuza@hotmail.com');
...
CREATE TABLE `status_log` (
  `id` int(11) NOT NULL COMMENT 'Auto generated ID for the table.',
  `user_id` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'This can be service dealer or DSD.',
  `ros_no` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `status` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `created_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Logs of the status of ROS';
...
CREATE TABLE `status_master` (
  `id` int(11) NOT NULL COMMENT 'Auto generated number of the table.',
...
CREATE TABLE `user_auth` (
  ...
  `user_role` varchar(1) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `user_auth` (`id`, `username`, `password`, `salt`, `last_password`, `sd_id`, `full_name`, `active`, `user_group`, `created_by`, `created_time`, `changed_by`, `changed_time`, `user_role`) VALUES
(1, 'denso', 'fe57ef7859f66dae98f0d6a07f56d63337fb387b5d3ad4ee72ae835bdd4f72fc', '45697b427ed0ddb4ac89ff48875bc6752f76398e399441254cad2ff97c09aa49', NULL, 'denso', 'Dealer', 1, 2, 'admin', '2015-03-05 18:59:32', 'admin', '2015-03-06 01:59:32', ''),
...
(10, 'sd001', '49d84c4cd2fa2c381098136e78aad01fc4845ad768089234918d45569aeef015', '1f5166e90df2dd7328f622f7a051bda84420d0d04d63c4e6d9ed232904962b4d', NULL, 'SD0001', 'Dhonsiri diesel', 1, 1, 'admin', '2015-01-24 17:25:00', 'admin', '2015-01-25 00:25:00', ''),
...
(14, 'win', '0dd0e61d67ba6dc238e961aeb6785e2792ca86cc39d6f18546a7bf07b6580300', '5fa5f542d5ad736e16b80b572b3a88aa8bd9b585821ebc0dcc4020a31f4e04e9', '0dd0e61d67ba6dc238e961aeb6785e2792ca86cc39d6f18546a7bf07b6580300', 'SD0001', 'DHONSIRI DIESEL (บริษัท ธนศิริดีเซล จำกัด)', 1, 1, 'denso', '2016-09-10 16:23:34', 'denso', '2016-09-10 23:56:01', ''),
(15, 'qq001', 'e568cd696f029e75b4592aa6cc9cf8224d39b9b3df90ed3271e61588f541da56', '8a82ea71920f4a75f8ec6435c2727e9e094ce34a518dab23003e5849f1da0695', 'e568cd696f029e75b4592aa6cc9cf8224d39b9b3df90ed3271e61588f541da56', 'SD0070', 'winney service (วินนี่ การช่าง)', 1, 1, 'denso', '2016-09-20 15:29:56', 'denso', '2016-09-20 23:32:13', ''),
(16, 'winney', 'b31047213ce9f726d9524156c0edf5aee8f53890193569d737b51851b40c8000', '19a9a5b06070a3c6c1aedf6d0d27de13071c66e471750078cc5b80921aa76932', NULL, 'SD0070', 'winney service (วินนี่ การช่าง)', 1, 1, 'denso', '2016-09-22 15:06:46', 'denso', '2016-09-22 22:06:46', '1');
...
CREATE TABLE `user_role` (
  ...
  `name_eng` varchar(20) CHARACTER SET utf8 NOT NULL,
  `name_th` varchar(20) CHARACTER SET utf8 NOT NULL
...
--
-- Indexes for table `alternator_parts`
--
ALTER TABLE `alternator_parts`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `car_makers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `maker_id` (`maker_id`);
...
--
-- Indexes for table `compressor_parts`
--
ALTER TABLE `compressor_parts`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `compressor_problem`
--
ALTER TABLE `compressor_problem`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `compressor_problem_id` (`compressor_problem_id`);

--
-- Indexes for table `compressor_repair`
--
ALTER TABLE `compressor_repair`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `compressor_repair_id` (`compressor_repair_id`);

--
-- Indexes for table `compressor_status`
--
ALTER TABLE `compressor_status`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `compressor_status_id` (`compressor_status_id`);

--
-- Indexes for table `compressor_type`
--
ALTER TABLE `compressor_type`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `compressor_type_id` (`compressor_type_id`);

--
-- Indexes for table `compressor_type_backup`
--
ALTER TABLE `compressor_type_backup`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `compressor_type_id` (`compressor_type_id`);
...
ALTER TABLE `customer_category`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `customer_category_id` (`customer_category_id`);
...
--
-- Indexes for table `dealer_relationship`
--
ALTER TABLE `dealer_relationship`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `sd_id` (`sd_id`);

--
-- Indexes for table `injector_parts`
--
ALTER TABLE `injector_parts`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `pump_parts`
--
ALTER TABLE `pump_parts`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ros_draft`
--
ALTER TABLE `ros_draft`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ros_form`
--
ALTER TABLE `ros_form`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ros_form_backup`
--
ALTER TABLE `ros_form_backup`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sd_map_parts`
--
ALTER TABLE `sd_map_parts`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `service_dealer`
--
ALTER TABLE `service_dealer`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `sd_id` (`sd_id`);

--
-- Indexes for table `starter_parts`
--
ALTER TABLE `starter_parts`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `warranty_condition`
--
ALTER TABLE `warranty_condition`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `alternator_parts`
--
ALTER TABLE `alternator_parts`
...
--
-- AUTO_INCREMENT for table `compressor_parts`
--
ALTER TABLE `compressor_parts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `compressor_problem`
--
ALTER TABLE `compressor_problem`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `compressor_repair`
--
ALTER TABLE `compressor_repair`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `compressor_status`
--
ALTER TABLE `compressor_status`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `compressor_type`
--
ALTER TABLE `compressor_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `compressor_type_backup`
--
ALTER TABLE `compressor_type_backup`
...
--
ALTER TABLE `customer_category`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Auto generated incremented Primary key of the table.', AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `dealer`
--
ALTER TABLE `dealer`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Auto generated key of the table.', AUTO_INCREMENT=844;
--
-- AUTO_INCREMENT for table `dealer_relationship`
--
ALTER TABLE `dealer_relationship`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Auto generated key of the table.', AUTO_INCREMENT=188;
--
-- AUTO_INCREMENT for table `injector_parts`
--
ALTER TABLE `injector_parts`
...
--
-- AUTO_INCREMENT for table `pump_parts`
--
ALTER TABLE `pump_parts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
-- AUTO_INCREMENT for table `ros_draft`
--
ALTER TABLE `ros_draft`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `ros_form`
--
ALTER TABLE `ros_form`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `ros_form_backup`
--
ALTER TABLE `ros_form_backup`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
--
-- AUTO_INCREMENT for table `sd_map_parts`
--
ALTER TABLE `sd_map_parts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Auto key.', AUTO_INCREMENT=25;
--
-- AUTO_INCREMENT for table `service_dealer`
--
ALTER TABLE `service_dealer`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
--
-- AUTO_INCREMENT for table `starter_parts`
--
ALTER TABLE `starter_parts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `status_log`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Auto generated ID for the table.', AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `status_master`
--
ALTER TABLE `status_master`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Auto generated number of the table.', AUTO_INCREMENT=8;
--
...
--
-- AUTO_INCREMENT for table `warranty_condition`
--
ALTER TABLE `warranty_condition`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Auto Generated key of the table', AUTO_INCREMENT=13;
