...
<div>
    ...
    <div class="outer center formtitle fixedfont" >
        ...
        <span style="display: inline-block; vertical-align: middle;"><h3>แบบฟอร์มขอแลกเปลี่ยนปั๊มน้ำมันเชื้อเพลิงและหัวฉีดไฟฟ้าสำหรับ (<?php echo ($this->input->get('CarMaker'))?$this->input->get('CarMaker'):'ชื่อยี่ห้อรถ'; ?>)</h3></span>
...
<!--            <td colspan="2" class="bordersolidright"><?php echo isset($sd_info[lang('create_sd_name')])?$sd_info[lang('create_sd_name')]:'____________________'; ?></td>-->
            ...
            <td colspan="3" class="bordersolidleft bold">ชื่อตัวแทนจำหน่ายรถยนต์ : </td>
    ...
    <table class="bordersolid outer fixedfont">
        ...
        <tr>
            ...
            <td class="bordersolidright"><?php echo ($this->input->get('part_exchange_pn') && (intval($this->input->get('part_id')) === 1))?$this->input->get('part_exchange_pn'):'__________' ?></td>
		...
		<tr>
            ...
            <td>ตัว</td>
            <td colspan="2">หมายเลขอะไหล่</td>
            <td class="bordersolidright"><?php echo ($this->input->get('part_exchange_pn') && (intval($this->input->get('part_id')) === 2))?$this->input->get('part_exchange_pn'):'__________' ?></td>
		...
		<tr>
            <td class="alignright">หมายเลขการผลิตอะไหล่ใหม่</td>
            <td>&nbsp;สูบที่</td>
            <td>1:</td>
            <td class="center"><?php echo ($this->input->get('new_sn_1') && (intval($this->input->get('part_id')) === 2))?$this->input->get('new_sn_1'):'__________' ?></td>
            <td>2:</td>
            <td class="center"><?php echo ($this->input->get('new_sn_2') && (intval($this->input->get('part_id')) === 2))?$this->input->get('new_sn_2'):'__________' ?></td>
            <td>3:</td>
            <td class="center"><?php echo ($this->input->get('new_sn_3') && (intval($this->input->get('part_id')) === 2))?$this->input->get('new_sn_3'):'__________' ?></td>
            <td>4:</td>
            <td class="center"><?php echo ($this->input->get('new_sn_4') && (intval($this->input->get('part_id')) === 2))?$this->input->get('new_sn_4'):'__________' ?></td>
            <td>5:</td>
            <td class="center"><?php echo ($this->input->get('new_sn_5') && (intval($this->input->get('part_id')) === 2))?$this->input->get('new_sn_5'):'__________' ?></td>
            <td>6:</td>
            <td class="center"><?php echo ($this->input->get('new_sn_6') && (intval($this->input->get('part_id')) === 2))?$this->input->get('new_sn_6'):'__________' ?></td>
        </tr>
    </table>
    <br /><br />
        ...
        <tr>
            ...
            <td valign="top">
                <table class="bordersolid fixedfont" style="width: 100%;">
                    <tr>
                        <td colspan="5" class="bold bordersolid">ผลการตรวจเช็คโดยตัวแทนจำหน่าย (<?php echo ($this->input->get('CarMaker'))?>)</td>
                    </tr>
                    <tr>
    ...
    <br /><br />
	<table cellpadding="10" class="bordersolid outer fixedfont">
        <tr>
            <td width="20%" class="bordersolid bold center">หมายเหตุ</td>
            <td><?PHP echo ($this->input->get('remark'))?></td>         
